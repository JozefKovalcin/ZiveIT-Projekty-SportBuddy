            ...
            {session ? (
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  {session.user?.image ? (
                    ...
                    <div className="w-10 h-10 gradient-primary rounded-full flex items-center justify-center">
                      <span className="text-lg font-semibold text-[color:var(--fluent-text-secondary)]">
                ...
                {isUserMenuOpen && (
                  ...
                  >
                    <div className="acrylic-strong border border-[color:var(--fluent-border)] rounded-xl overflow-hidden reveal-effect w-56"
                         style={{
