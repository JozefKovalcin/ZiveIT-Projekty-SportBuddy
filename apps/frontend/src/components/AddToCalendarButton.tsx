...
export default function AddToCalendarButton({
  ...
  const handleCalendarOption = async (option: string) => {
    ...
    try {
      ...
      alert('Nepodarilo sa pridať do kalendára. Skúste to znova.');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="absolute right-0 mt-2 w-56 rounded-lg bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 z-50">
            <div className="py-1">
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200">Google Calendar</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200">Apple Calendar</span>
              </button>
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="#0078D4" d="M7 12.5C7 10.57 8.57 9 10.5 9h7c1.93 0 3.5 1.57 3.5 3.5v5c0 1.93-1.57 3.5-3.5 3.5h-7C8.57 21 7 19.43 7 17.5v-5z"/>
                  <path fill="#0364B8" d="M3 8.5C3 6.57 4.57 5 6.5 5h7C15.43 5 17 6.57 17 8.5v5c0 1.93-1.57 3.5-3.5 3.5h-7C4.57 17 3 15.43 3 13.5v-5z"/>
                  <path fill="#FFF" d="M8.5 8C7.67 8 7 8.67 7 9.5v4c0 .83.67 1.5 1.5 1.5h4c.83 0 1.5-.67 1.5-1.5v-4c0-.83-.67-1.5-1.5-1.5h-4z"/>
                </svg>
                <span className="text-gray-700 dark:text-gray-200">Outlook Calendar</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200">Office 365</span>
              </button>
              ...
              >
                ...
                <span className="text-gray-700 dark:text-gray-200">Stiahnuť .ics súbor</span>
              </button>
            </div>
          </div>
        </>
